...
int64 nChainStartTime = 1397784495;
int64 nNextStageTime = 1518158920;
...
const string strMessageMagic = "General Signed Message:\n";
...
// general: increasing Nfactor gradually
...
int64 GetProofOfWorkReward(unsigned int nBits, int nHeight)
{
      if(nHeight<=1)
       {
       return COIN*10000000;//100000;
       }
      else if(nHeight<=50000){
      return MAX_MINT_PROOF_OF_WORK;
      }
       else{
           int nSubsidy=std::floor( nHeight/50000.00);
...
static const int64 nTargetTimespan = 1* 1 * 6 * 60;  //

// get proof of work blocks max spacing according to hard-coded conditions
static const int64 nTargetSpacingWorkMax = 2 * nStakeTargetSpacing; // 2-hour
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in General
    bool fStrictPayToScriptHash = true; // Always active in General
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "General", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
       ...
       // time_t now;
        ...
        //assert(now<nChainStartTime);



        const char* pszTimestamp = "XHU5NTdGXHU2Qzk5XHU5MDFBXHU2NjEzXHU4RjZGXHU0RUY2XHU3OUQxXHU2MjgwXHU2NzA5XHU5NjUwXHU1MTZDXHU1M0Y4 fr0m general";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x5038f2604ac2c9bbea5d7e57906fc6d932dd4b186d341ac02c140d897734755e"));
        block.print();
