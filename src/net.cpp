...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "General " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"general.ie1.cn", "seeds.general.ie1.cn"},
    {"general.ie1.cn", "seed1.general.ie1.cn"},
    {"general.ie1.cn", "seed2.general.ie1.cn"},
    {"general.ie1.cn", "tnseeds.general.ie1.cn"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. General is probably already running."), addrBind.ToString().c_str());
        else
